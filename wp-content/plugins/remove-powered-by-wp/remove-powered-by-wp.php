...
if (!class_exists('remove_powered_by_wp_class')) {
	...
	class remove_powered_by_wp_class {
        ...
        function rpbw_customize_register($wp_customize) {
            ...
            if (!in_array(get_template(), array('newsup', 'twentyseventeen', 'twentytwenty'), true)) {
